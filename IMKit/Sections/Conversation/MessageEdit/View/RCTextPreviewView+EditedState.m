//
//  RCTextPreviewView+EditedState.m
//  RongIMKit
//
...
@implementation RCTextPreviewView (EditedState)
...
+ (void)edit_showText:(NSString *)text messageId:(long)messageId edited:(BOOL)edited delegate:(id<RCTextPreviewViewDelegate>)delegate {
    ...
    NSString *displayText = [RCEditedStateUtil displayTextForOriginalText:originalText isEdited:edited];
