...
- (void)addSubViewConstraints {
    ...
    [NSLayoutConstraint activateConstraints:@[
        // 头像高度
        [self.headerView.heightAnchor constraintEqualToConstant:RCKitConfigCenter.ui.globalConversationPortraitSize.height],
        ...
        [self.detailContentView.trailingAnchor constraintEqualToAnchor:self.statusView.leadingAnchor
                                                              constant:-8],
        // detailContentView 高度固定 16，与内部 messageContentLabel 一致
