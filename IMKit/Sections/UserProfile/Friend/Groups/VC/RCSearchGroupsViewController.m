//
//  RCSearchGroupsViewController.m
//  RongIMKit
//
...
@interface RCSearchGroupsViewController ()<UITableViewDelegate, UITableViewDataSource,RCListViewModelResponder>

@property (nonatomic, strong) RCSearchGroupsViewModel *viewModel;
@property (nonatomic, strong) RCMyGroupsView *listView;
@end


@implementation RCSearchGroupsViewController
