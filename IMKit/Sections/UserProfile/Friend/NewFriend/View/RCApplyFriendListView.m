...
@interface RCApplyFriendListView()
...
@implementation RCApplyFriendListView
...
- (void)layoutSubviews {
    ...
    self.labEmpty.center = self.tableView.center;
}
...
- (UILabel *)labEmpty {
    if (!_labEmpty) {
        ...
        lab.text = RCLocalizedString(@"FriendsApplicationEmpty");
