//
//  RCGroupRemoveMembersViewController.m
//  RongIMKit
//
...
@implementation RCRemoveGroupMembersViewController

- (instancetype)initWithViewModel:(RCRemoveGroupMembersViewModel *)viewModel {
    self = [super init];
    if (self) {
        self.viewModel = viewModel;
        [self.viewModel bindResponder:self];
        self.title = RCLocalizedString(@"GroupMembersKick");
    }
    return self;
}
