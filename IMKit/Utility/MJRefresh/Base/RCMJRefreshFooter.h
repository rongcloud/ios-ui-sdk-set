...
@interface RCMJRefreshFooter : RCMJRefreshComponent
/** 创建footer */
...
- (void)noticeNoMoreData RCMJRefreshDeprecated("使用endRefreshingWithNoMoreData");
...
@property (assign, nonatomic, getter=isAutomaticallyHidden)
    BOOL automaticallyHidden RCMJRefreshDeprecated("已废弃此属性，开发者请自行控制footer的显示和隐藏");
@end
